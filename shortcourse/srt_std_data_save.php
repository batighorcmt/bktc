...
if($result == True AND move_uploaded_file($file_temp, $uploaded_image)){
  ...
  echo "<script>window.location.assign('print_app.php?cnumber=$cnumber&app_id=$last_id');</script>";
}
else{
    echo "<script>window.location.assign('srt_std_reg.php?error=Something went wrong!');</script>";
}
?>