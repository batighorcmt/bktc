...
<div class="container mt-3 mb-5">
  ...
  <form action="srt_std_data_save.php" method="post" class="form-horizontal validate" role="form" enctype="multipart/form-data">
    <div class="card mb-3">
      <div class="card-header bg-primary text-white">
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <h6 class="mb-0">Short Course Application</h6>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input type="number" name="cnumber" id="cnumber" class="form-control form-control-sm" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input type="number" name="gnumber" id="gnumber" class="form-control form-control-sm" required>
              </div>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <div class="row">
                  ...
                  <div class="col-4">
                    <input type="number" name="brdateyear" class="form-control form-control-sm" placeholder="Year" required>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input type="number" name="nid" id="nid" class="form-control form-control-sm" required>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="number" name="jscyear" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="number" name="jscroll" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="number" name="jscregi" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Passing Year</label>
                <div class="col-md-8">
                  <input type="number" name="sscyear" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Roll</label>
                <div class="col-md-8">
                  <input type="number" name="sscroll" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Reg. Number</label>
                <div class="col-md-8">
                  <input type="number" name="sscregi" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Passing Year</label>
                <div class="col-md-8">
                  <input type="number" name="hscyear" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row mt-2">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Reg. Number</label>
                <div class="col-md-8">
                  <input type="number" name="hscregi" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Passing Year</label>
                <div class="col-md-8">
                  <input type="number" name="degyear" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Roll</label>
                <div class="col-md-8">
                  <input type="number" name="degroll" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Reg. Number</label>
                <div class="col-md-8">
                  <input type="number" name="degregi" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Passing Year</label>
                <div class="col-md-8">
                  <input type="number" name="masyear" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Roll</label>
                <div class="col-md-8">
                  <input type="number" name="masroll" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                <label class="col-md-4 col-form-label">Reg. Number</label>
                <div class="col-md-8">
                  <input type="number" name="masregi" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="number" name="pamount" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
          <div class="row mt-2">
            <div class="col-md-4">
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="number" name="rmobile" class="form-control form-control-sm">
                </div>
              </div>
            </div>
            <div class="col-md-4">
        ...
        <input type="hidden" name="course_type" id="course_type" value="Short">
        <div class="form-group row">
