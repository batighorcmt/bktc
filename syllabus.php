...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <title>Syllabus | Bamundi Karigori Training Center</title>	
...
<hr>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-12"> 
              <div class="card">
                <h5 class="card-header" style="background-color:#00a953; color:#FFFFFF; margin:10px; border-radius:5px;"><strong>সিলেবাস সমূহ</strong></h5>
                <div class="card-body">
                    <table class="table table-bordered table-striped mb-none" id="datatable-editable">
                        <thead>
                        <tr align="Center">
                        <th>ক্রমিক</th>
                        <th width="25%">কোর্সের নাম</th>
                        <th width="40%">সিলেবাসের বিষয়</th>
                        <th>ডাউনলোড</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <td><?=$row['sly_title'];?></td>
                        <th align="Center">
                          <a href="syllabus/<?=$row['sly_file'];?>"><img src="site_images/download.png" height=20% width=20%></th>
                        </tr>
                        <?php $i++; } ?>                                                                       
                        </tbody>
                    </table>
