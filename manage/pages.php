...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="<?=$row['page_meta'];?>s">
  <meta name="keywords" content="<?=$row['page_tag'];?>">
    
 <title><?=$row['page_title'];?> | Bamundi Karigori Training Center</title>	
...
<hr>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-12"> 
              <div class="card">
                <h5 class="card-header" style="background-color:#00a953; color:#FFFFFF; margin:10px; border-radius:5px;"><strong><?=$row['page_title'];?></strong></h5>
                <div class="card-body">

<?=$row['page_content'];?>

<hr>
<small>Tags: <?=$row['page_tag'];?></small>
              </div>
            </div>
          </div>
              </div>
