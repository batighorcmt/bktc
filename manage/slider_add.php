<?php 
   ...
   if (isset($_SESSION['username']) && isset($_SESSION['id'])) {   
    ...
    $std = "select * from slider order by id desc limit 1";
       ...
       ?>
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                ...
                <div class="card-body">  
         <form role="form" method="post" action="slider_add_save.php" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6">
                <div class="form-group">
                    <label>Slider ID</label>
                       <input name="id" readonly value="<?php echo $id; ?>" class="form-control" style="width: 100%;" >
                  </div><!-- /.form-group -->
            
                <div class="form-group">
                    <label>Slide Title</label>
                       <input name="title" class="form-control" style="width: 100%;" required >
                  </div><!-- /.form-group -->
                  
                   	<div class="form-group">
                    	<label>Slide Text</label>
						<input name="text" class="form-control" style="width: 100%;" >
					</div><!-- /.form-group -->
