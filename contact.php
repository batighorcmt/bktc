...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <title>Contact us | Bamundi Karigori Training Center</title>	
...
<hr>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-12"> 
              <div class="card">
                <h5 class="card-header" style="background-color:#00a953; color:#FFFFFF; margin:10px; border-radius:5px;"><strong>যোগাযোগ মাধ্যম</strong></h5>
                <div class="card-body">
...
<section class="contact" id="contact">
        <div class="container">
            <div class="heading text-center">
                <h2>Contact
                    <span> Us </span></h2>
                <p>Bamundi Karogori Training Center is first and only one institute in Meherpur district who have NSDA Approval. 
                    <br>BTEB and NSDA Approval. BTEB Approval No-28042 and NSDA Approval No-0000050 </p>
            </div>
            <div class="row">
                <div class="col-md-5">
                    <div class="title">
                        <h3>Contact detail</h3>
                        <p>Fell free to contact with us. </p>
                    </div>
                    <div class="content">
                        <!-- Info-1 -->
                        <div class="info">
                            ...
                            <h4 class="d-inline-block">PHONE :
                                <br>
                                <span>01719799089, 01701315034</span></h4>
                        </div>
                        <!-- Info-2 -->
                        <div class="info">
                            ...
                            <h4 class="d-inline-block">EMAIL :
                                <br>
                                <span>bktc28042@gmail.com</span></h4>
                        </div>
                        <!-- Info-3 -->
                        <div class="info">
                            <i class="fa fa-map-marker"></i>
                            <h4 class="d-inline-block">ADDRESS :<br>
                                <span>Bamundi Poshu Hat Road, Bamundi, Gangni, Meherpur.</span></h4>
                        </div>
                    </div>
                </div>
                	...
                	<div class="container">
                    	<div class="row" style="margin-top: 10px;">
                        	<div class="col-md-4" >
                              ...
                              <div>BTEB Code-28042, NSDA Code-0000050</div>
