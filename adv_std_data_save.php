...
$sql = "INSERT INTO application (insname, ssession, pic_file, studname, cnumber, fathername, mothername, gnumber, studemail, brdateday, brdatemonth, brdateyear, dob, selecttrade, course, religion, gender, saddress, selnation, bg, nid, sscboard, sscyear, sscroll, sscresult, sscgrade, sscregi, jscboard, jscyear, jscroll, jscresult, jscgrade, ptype, pdate, pamount, rmobile, rtransection, reference, app_status) VALUES ('$insname', '$ssession', '$unique_image', '$studname', '$cnumber', '$fathername', '$mothername', '$gnumber', '$studemail', '$brdateday', '$brdatemonth', '$brdateyear', '$dob', '$selecttrade', '$course', '$religion', '$gender', '$saddress', '$selnation', '$bg', '$nid', '$sscboard', '$sscyear', '$sscroll', '$sscresult', '$sscgrade', '$sscregi', '$jscboard', '$jscyear', '$jscroll', '$jscresult', '$jscgrade', '$ptype', '$pdate', '$pamount', '$rmobile', '$rtransection', '$reference', 'Applied')";
